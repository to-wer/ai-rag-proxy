...
public class ProviderConfigurationControllerTests
{
    ...
    {
        // Arrange
        var dto = new CreateProviderConfigurationDto
        {
            Name = "TestProvider", BaseUrl = "http://test.com", ProviderType = ProviderType.OpenAI,
            AuthenticationType = AuthenticationType.ApiKey
        };
        var createdConfig = new ProviderConfiguration
        {
            Id = 1, Name = "TestProvider", BaseUrl = "http://test.com", ProviderType = ProviderType.OpenAI,
            AuthenticationType = AuthenticationType.ApiKey
        };
    ...
    public async Task GetProviderConfiguration_ReturnsOk_WhenConfigurationExists()
    {
        // Arrange
        var id = 1;
        var configDto = new ProviderConfigurationDto
        {
            Id = id, Name = "TestProvider", BaseUrl = "http://test.com", ProviderType = ProviderType.OpenAI,
            AuthenticationType = AuthenticationType.ApiKey
        };
        _providerConfigurationServiceMock
    ...
    public async Task GetAllProviderConfigurations_ReturnsOk_WithListOfConfigurations()
    {
        ...
        var configsDto = new List<ProviderConfigurationDto>
        {
            ...
            {
                Id = 1, Name = "TestProvider1", BaseUrl = "http://test1.com", ProviderType = ProviderType.OpenAI,
                AuthenticationType = AuthenticationType.ApiKey
            },
            new ProviderConfigurationDto
            {
                Id = 2, Name = "TestProvider2", BaseUrl = "http://test2.com", ProviderType = ProviderType.AzureOpenAI,
                AuthenticationType = AuthenticationType.AzureAad
            }
        };
        _providerConfigurationServiceMock
